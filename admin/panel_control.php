...
<head>
    ...
    <title>Panel Admin - HMBRAKE-ECOMMERCE</title>
    ...
    <style>
        ...
        /* COLORES */
        .bg-products {
            background: linear-gradient(45deg, #00ff6a, #f700ff);
            color: white;
        }

        .bg-orders {
            background: linear-gradient(45deg, #a77028, #85e085);
            color: white;
        }
...
<body>
    ...
    <nav class="navbar navbar-dark">
        <div class="container d-flex justify-content-between">
            <span class="navbar-brand">⚡ HMBRAKE Admin</span>
